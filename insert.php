...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <a class="navbar-brand" href="#">Movies Data </a>
    </nav>

    <div class="container">
      <div class="row">
        <div class="col-lg-12">
            <div class="container"><h1 class="text-center text-primary"><B>InsertData</B></h1></div>
                ...
                method="POST">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="date" name="year" id="year" class="form-control" autocomplete="off" value="<?=$year?>">
                  </div>
